...
import de.linogistix.wmsprocesses.processes.fuel.gui.component.*;
...
public class HeaderPanel extends AbstractHeaderPanel {
    ...
    private void postInit() {
        super.headerLabel.setText(NbBundle.getMessage(WMSProcessesBundleResolver.class,"CreateFuel"));
    }
